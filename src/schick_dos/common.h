...
enum {
	...
	FIG_ACTION_CHANGE_WEAPON   =   7,
	FIG_ACTION_CHANGE_ITEM     =   8,
...
enum {
	ACTOR_CLASS_TYPE_MONSTER = 1,
	ACTOR_CLASS_TYPE_HERO    = 2
};
...
enum {
	...
	WEAPON_GFX_ID_MELEE_BLUNT    =  1, /* ITEM_ID_KNUEPPEL, ITEM_ID_MORGENSTERN, ITEM_ID_STREITKOLBEN, ITEM_ID_KAMPFSTAB,
					       * ITEM_ID_PEITSCHE, ITEM_ID_KRIEGSHAMMER, ITEM_ID_HEXENBESEN, ITEM_ID_ZAUBERSTAB */
	WEAPON_GFX_ID_MELEE_BLADE    =  2, /* all other melee weapons */
	WEAPON_GFX_ID_RANGED_MISSILE =  3, /* ITEM_ID_SCHLEUDER, ITEM_ID_KURZBOGEN, ITEM_ID_LANGBOGEN, ITEM_ID_ARMBRUST */
	WEAPON_GFX_ID_RANGED_THROW   =  4, /* all throwing weapons except throwing spears  */
...
enum {
	FIG_BACKGROUND_ID_DUNGEON_BORDERED = 0, // ARCHIVE_FILE_KDLBACK_DAT  (Kampf Dungeon Leer Background -> KDLBACK)
	FIG_BACKGROUND_ID_CITY_BORDERED    = 1, // ARCHIVE_FILE_KCLBACK_DAT  (Kampf City Leer BACKground -> KCLBACK)
	FIG_BACKGROUND_ID_LAND_BORDERED    = 2, // ARCHIVE_FILE_KLLBACK_DAT  (Kampf Land Leer BACKground -> KLLBACK)
	FIG_BACKGROUND_ID_SHIP_BORDERED    = 3, // ARCHIVE_FILE_KSLBACK_DAT  (Kampf Ship Leer BACKground -> KCLBACK)
	FIG_BACKGROUND_ID_DUNGEON_OPEN     = 4, // ARCHIVE_FILE_KDBACK_DAT   (Kampf Dungeon BACKground -> KDBACK)
	FIG_BACKGROUND_ID_CITY_OPEN        = 5, // ARCHIVE_FILE_KCBACK_DAT   (Kampf City BACKground -> KCBACK)
	FIG_BACKGROUND_ID_LAND_OPEN        = 6, // ARCHIVE_FILE_KLBACK_DAT   (Kampf Land BACKground -> KLBACK)
	FIG_BACKGROUND_ID_SHIP_OPEN        = 7  // ARCHIVE_FILE_KSBACK_DAT   (Kampf Ship BACKground -> KCBACK)
};
